/*Comment section:
  - Add info printout: Amount of hits among all hyprots
  - Access gff, faa etc file in python script via relative paths in working dir and not by parameter flag?? =>
